...
// 特效武器
export const 特效_武器_普通: EquipmentIds = [36660, 36657]
export const 特效_武器_英雄: EquipmentIds = [35781]
// 特效腰坠
export const 特效_腰椎_普通: EquipmentIds = [37720]
export const 特效_腰椎_英雄: EquipmentIds = [38791]
// 切糕套装
export const 切糕套装_普通: EquipmentIds = [94464, 94488, 94482, 94476, 94470, 94494]

export const 切糕套装_英雄: EquipmentIds = [96367, 96391, 96385, 96379, 96373, 96397]
// 大CW特效Ids
...
// 2件套 饮羽10% 4件套会心
export const 套装_两件套技能: EquipmentIds = [97846, 97849, 97848, 97847, 97850]
