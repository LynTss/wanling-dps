...
export const 完整技能伤害 = (params: 完整技能伤害入参类型) => {
  ...
  if (当前技能属性?.技能名称?.includes('贯穿')) {
    console.log('----!!!!!!!!!!')
    console.log('当前技能属性?', 当前技能属性?.技能名称)
    console.log('郭式无视防御', 郭式无视防御)
    console.log('当前技能属性', 当前技能属性)
    console.log('技能总数', 技能总数)
    console.log('基础伤害', 基础伤害)
    console.log('伤害增加', 伤害增加)
    console.log('破防伤害', 破防伤害)
  }
  /**
   * 计算会心伤害
...
const 会效后计算公式 = (伤害, 计算类型: '会心' | '非会心', params: 完整技能伤害入参类型) => {
  ...
  if (params?.当前技能属性?.技能名称?.includes('贯穿') && 计算类型 !== '会心') {
    console.log('等级减伤伤害', 等级减伤伤害)
    console.log('无双增伤伤害', 无双增伤伤害)
    console.log('非侠士增伤伤害', 非侠士增伤伤害)
    console.log('易伤增伤伤害', 易伤增伤伤害)
  }
  return 易伤增伤伤害
}
