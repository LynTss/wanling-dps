...
export const geSkillTotalDps = (
  ...
  // 郭式身法对人物属性身法的提升值
  const 郭式身法对属性身法的提升值 = 增益计算基础?.最终人物属性.身法 * 身法提升百分比
  // 郭式力道对增益提供的力道二次加成提升值
  const 郭式力道对增益内力道的提升值 = 增益计算基础?.身法数值加成 * 身法提升百分比
  // 身法数值的提升值
  ...
  增益计算基础 = {
    ...
    最终人物属性: {
      ...
      面板攻击: 增益计算基础?.最终人物属性.面板攻击 + 总身法提升值 * 加成系数.身法加成面板攻击,
      会心值: 增益计算基础?.最终人物属性.会心值 + 总身法提升值 * 加成系数.身法加成会心,
    },
  }
